...
public class MainActivity extends FragmentActivity implements View.OnClickListener, GoogleMap.OnMapClickListener, OnMapReadyCallback {
    ...
    private Button locate, add, clear, britishPelican;
    ...
    private void initUI() {
        ...
        britishPelican = (Button) findViewById(R.id.britishPelican);
        ...
        britishPelican.setOnClickListener(this);
    }
...
//----DroneSoc----
            ...
            case R.id.britishPelican:{
                DJIDemoApplication.getAircraftInstance().getFlightController().setGoHomeHeightInMeters(50f,new CommonCallbacks.CompletionCallback() {
                    ...
                    public void onResult(DJIError error) {
                        setResultToToast("homeSetHeight: " + (error == null ? "Successfully" : error.getDescription()));
                    }
                });
                DJIDemoApplication.getAircraftInstance().getFlightController().setHomeLocationUsingAircraftCurrentLocation(new CommonCallbacks.CompletionCallback() {
                    @Override
                    public void onResult(DJIError error) {
                        setResultToToast("Location set at drone location: " + (error == null ? "Successfully" : error.getDescription()));
                    }
                });
    ...
    private void startBritishPelican() {
        ...
        do {
            ...
            startWaypointMission();
        } while(reachedCustomer ==false );      //tracking object


        landAtCustomer();
/*
        //wait for takeoff to be give
        try
        {
            Thread.sleep(20000);
        }
    ...
    private void landAtCustomer() {
        stopWaypointMission();  //stop tracting
        //land at customer
        DJIDemoApplication.getAircraftInstance().getFlightController().startLanding(new CommonCallbacks.CompletionCallback() {
            @Override
            public void onResult(DJIError error) {
                setResultToToast("Landing: " + (error == null ? "Successfully" : error.getDescription()));
            }
        });

        DJIDemoApplication.getAircraftInstance().getFlightController().confirmLanding(new CommonCallbacks.CompletionCallback() {
            @Override
            public void onResult(DJIError error) {
                setResultToToast("Landed: " + (error == null ? "Successfully" : error.getDescription()));
            }
        });
    }
    ...
    private void droneTakeOff() {
        DJIDemoApplication.getAircraftInstance().getFlightController().startTakeoff(new CommonCallbacks.CompletionCallback() {
            @Override
            public void onResult(DJIError error) {
                setResultToToast("Taking off: " + (error == null ? "Successfully" : error.getDescription()));
            }
        });
    ...
    private void droneGoHome() {
        ...
        DJIDemoApplication.getAircraftInstance().getFlightController().startGoHome(
            new CommonCallbacks.CompletionCallback() {
                @Override
                public void onResult(DJIError error) {
                    setResultToToast("RTH: " + (error == null ? "Successfully" : error.getDescription()));
                    DJIDemoApplication.getAircraftInstance().getFlightController().confirmLanding(new CommonCallbacks.CompletionCallback() {
                        @Override
                        public void onResult(DJIError error) {
                            setResultToToast("Landed: " + (error == null ? "Successfully" : error.getDescription()));
